...
HD44780_PCF8574::HD44780_PCF8574(TWI *twi, uint8_t A2, uint8_t A1, uint8_t A0, uint32_t clockFrequency, HD44780_Type displayType)
{
	this->twi = twi;
...
void HD44780_PCF8574::ClearArea(uint8_t length, uint8_t slot, uint8_t line)
{
	...
	{				
		memmove(buffer[this->writePointer] + i, (uint8_t*)&_data, sizeof(uint32_t));
	}
...
{	
	...
	memmove(buffer[this->writePointer], (uint8_t*)&_data, sizeof(uint32_t));
